...
```{r network-param, message=F, warning=F, fig.width = 3, fig.height = 3}
...
```{r network-layout, message=F, warning=F, fig.width = 3, fig.height = 3}
# example data
...
```{r network-highlight-nodes, message=F, warning=F, fig.width = 3, fig.height = 3}
...
```{r network-highlight-path, message=F, warning=F, fig.width = 3, fig.height = 3}
...
```{r network-highlight-edges, message=F, warning=F, fig.width = 3, fig.height = 3}
...
```{r network-highlight-neighbor, message=F, warning=F, fig.width = 3, fig.height = 3}
